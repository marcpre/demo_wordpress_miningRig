...
class RigBuilder {
    ...
    events() {
        ...
        $(".sn-youtube").on("click", this.youtubeCode.bind(this))
        $(".sn-discord").on("click", this.discordCode.bind(this))
    ...
    saveBuild() {
        ...
        let youtubeSharing = $(".socialnetworkcontent.form-control.youtube").val()
        let discordSharing = $(".socialnetworkcontent.form-control.discord").val()
        ...
        const newBuild = {
            ...
            'youtube_sharing': youtubeSharing,
            'discord_sharing': discordSharing,
            'status': 'publish'
        }
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                swal({
                    title: "Good job! 👍",
                    text: "👑Share the 🔗link below with your mining fellows!😍😍😍",
                    content: {
                        element: "input",
                        attributes: {
                            type: "text",
...
[i]Generated by [url=${miningRigData.root_url}]Mining Rig Builder[/url][/i]`
    ...
    youtubeSharingCode() {
        ...
        let url = miningRigData.root_url.replace("http://", "")
        ...
        Object.values(result).forEach(({
            ...
            category.forEach(({
                ...
                (categories[cat_name] = categories[cat_name] || []).push({
                    title,
                    price,
                    cat_name
                })
        ...
        Object.entries(categories).forEach(([category, products]) => {
            ...
            products.forEach(({
                title,
                price
            }) => items += `-> _${title}_ ($${price})\n`);
        });

        $(".socialnetworkcontent.form-control").val(
            `${url} - *Mining Rig Builder* 
${items}
*Current Total:* $${this.overallPrice}

Generated by ${url} on ${today}`
        );
    }
    ...
    discordSharingCode() {
        let obj = {}
        obj = this.buildResultsObjGlobal
...
Generated by ${url} on ${today}\`\`\` `
    ...
    clearModals() {
        ...
        // Youtube
        $("#youtubeModal").on("hidden.bs.modal", () => {
            $('.socialnetworkcontent').html('')
        });
        // Discord
        $("#discordModal").on("hidden.bs.modal", () => {
            $('.socialnetworkcontent').html('')
        });
    }
