  ...
  function () {
    ...
    _createClass(Modal, [{
      ...
      value: function hide(event) {
        ...
        if (transition) {
          $(this._element).one(_util.default.TRANSITION_END, function (event) {
...
function () {
  ...
  _createClass(RigBuilder, [{
    ...
    value: function events() {
      ...
      (0, _jquery.default)("#miningRigTable").on("click", ".btn.btn-danger.btn-sm.deleteMe", this.deleteRow.bind(this)); // Social Networks
    ...
    value: function saveBuild() {
      ...
      var miningRigDescription = (0, _jquery.default)(".form-control.miningRigDescription").val(); // sharing codes
    ...
    value: function redditCode(e) {
      e.preventDefault();
      this.redditSharingCode();
      (0, _jquery.default)('#redditModal').modal('show');
    }
  }, {
    key: "redditSharingCode",
    value: function redditSharingCode() {
      var result = {};
      result = this.buildResultsObjGlobal;
      var items = "";

      for (var key in result) {
        items += "**".concat(result[key].category["0"].cat_name, "** | [").concat(result[key].title, "](").concat(result[key].affiliateLink, ") | $").concat(result[key].price) + "\n";
      }

      items = items.replace(/\n$/, "");
      (0, _jquery.default)(".socialnetworkcontent.form-control.reddit").append("[Mining Rig Builder](".concat(miningRigData.root_url, ")\n          \nType|Item|Price\n:----|:----|:----\n").concat(items.replace(/\n$/, ""), "\n | | **Total**\n | Price may include shipping, rebates, promotions, and tax | $").concat(this.overallPrice, "\n | Generated by [Mining Rig Builder](").concat(miningRigData.root_url, ") |"));
    }
  }, {
    key: "twitchCode",
    value: function twitchCode(e) {
      e.preventDefault();
      this.twitchSharingCode();
      (0, _jquery.default)('#twitchModal').modal('show');
    }
  }, {
    key: "twitchSharingCode",
    value: function twitchSharingCode() {
      var result = {};
      result = this.buildResultsObjGlobal;
      var items = "";

      for (var key in result) {
        items += "**".concat(result[key].category["0"].cat_name, "**|||| [").concat(result[key].title, "](").concat(result[key].affiliateLink, ")") + "\n";
      }

      items = items.replace(/\n$/, "");
      (0, _jquery.default)(".socialnetworkcontent.form-control").append("# [Mining Rig Builder](".concat(miningRigData.root_url, ")\n ||||\n:----||||:----\n").concat(items.replace(/\n$/, ""), "\n |||| \n ||||\n |||| **[Generated by Mining Rig Builder](").concat(miningRigData.root_url, ")**"));
    }
  }, {
    key: "vBCodeCode",
    value: function vBCodeCode(e) {
      e.preventDefault();
      this.vbcodeSharingCode();
      (0, _jquery.default)('#vBCodeModal').modal('show');
    }
  }, {
    key: "vbcodeSharingCode",
    value: function vbcodeSharingCode() {
      var result = {};
      result = this.buildResultsObjGlobal;
      var items = "";
    ...
    key: "clearModals",
    value: function clearModals() {
      // Reddit
      (0, _jquery.default)("#redditModal").on("hidden.bs.modal", function () {
        (0, _jquery.default)('.socialnetworkcontent').html('');
      }); // Twitch

      (0, _jquery.default)("#twitchModal").on("hidden.bs.modal", function () {
        (0, _jquery.default)('.socialnetworkcontent').html('');
      }); // vBCode
